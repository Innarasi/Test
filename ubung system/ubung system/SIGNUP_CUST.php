...
if(isset($_POST['SignUp'])){
	if(empty($_POST['firstname_cust']))
	{
	echo 'firstname is required<br/>';
	}
	else
	{
		echo $_POST['firstname_cust'];
		}
		
	if(empty($_POST['lastname_cust']))
	{
	echo 'lastname is required<br/>';
	}
	else
	{
		echo $_POST['lastname_cust'];
		}
		
	if(empty($_POST['contactnum_cust']))
	{
	echo 'contact number is required<br/>';
	}
	else
	{
		echo $_POST['contactnum_cust'];
		}
	
	if(empty($_POST['address_cust']))
	{
	echo 'address is required<br/>';
	}
	else
	{
		echo $_POST['address_cust'];
		}
...
<div class="sidebar">
  ...
  <h4 class="center">Customer Sign Up</h4>
  <form class="white" action="Customer.php" method="post">
  <label>First name:</label>
  <input type="text" name="firstname_cust">
  <label>Last name:</label>
  <input type="text" name="lastname_cust">
  <label>Contact number:</label>
  <input type="text" name="contactnum_cust">
  <label>Address:</label>
